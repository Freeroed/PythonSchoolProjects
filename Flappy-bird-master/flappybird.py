...
pimg=[pygame.image.load('d:\\LABS\\School\\PythonSchoolProjects\\Flappy-bird-master\\' + str(i)+'.png') for i in range(1,5)]
clock=pygame.time.Clock()
vec=pygame.math.Vector2
bg=pygame.image.load('d:\\LABS\\School\\PythonSchoolProjects\\Flappy-bird-master\\bg.png')
bw=bg.get_width()
...
class TBlock(pygame.sprite.Sprite):
   def __init__(self,x,h1):
      super().__init__()
      self.image=pygame.image.load('d:\\LABS\\School\\PythonSchoolProjects\\Flappy-bird-master\\tp.png')
...
class BBlock(pygame.sprite.Sprite):
   def __init__(self,x,h2):
      super().__init__()
      self.image=pygame.image.load('d:\\LABS\\School\\PythonSchoolProjects\\Flappy-bird-master\\bp.png')
